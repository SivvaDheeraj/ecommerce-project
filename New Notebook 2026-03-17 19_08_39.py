...
storage_account = "ecommdheerajdl"
application_id = "b1f2e3bc-360f-422c-b713-f789acae328d"
directory_id = "9dd853c8-950c-41ea-ae53-9cf51b96f08c"

spark.conf.set(f"fs.azure.account.auth.type.{storage_account}.dfs.core.windows.net", "OAuth")
spark.conf.set(f"fs.azure.account.oauth.provider.type.{storage_account}.dfs.core.windows.net", "org.apache.hadoop.fs.azurebfs.oauth2.ClientCredsTokenProvider")
spark.conf.set(f"fs.azure.account.oauth2.client.id.{storage_account}.dfs.core.windows.net", application_id)
spark.conf.set(f"fs.azure.account.oauth2.client.secret.{storage_account}.dfs.core.windows.net", "Tnx8Q~iYO11UDH2iq.bJpM8HKjM8_ypoijf99cSQ")
...
format("csv")\
.option("header", "true")\
.load(f"abfss://ecommdheeraj@ecommdheerajdl.dfs.core.windows.net/bronze/olist_customers_dataset.csv")

display(customer_df)

# COMMAND ----------

base_path = "abfss://ecommdheeraj@ecommdheerajdl.dfs.core.windows.net/bronze/"
...
hostname = "r2fw6f.h.filess.io"
database = "ecommerceNosql_operation"
port = "61004"
username = "ecommerceNosql_operation"
password = "8204ba4f1007bf815cc8b4197069ebf5f3e3c772"
...
final_df.write.mode("overwrite").parquet("abfss://ecommdheeraj@ecommdheerajdl.dfs.core.windows.net/silver")